...
--> /* 회원가입 정보 유효성 검사 client 단에서 처리 script */
</script>
</head>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						<a href="javascript:fncAddUser();">가입</a> <!-- 어떻게 a 링크로 submit 기능을 하는지 확인 -->
					</td>
...
<script type="text/javascript">
document.getElementById("btnCmfID").focus(); //이거 아마 id 유효성 검사 확인
</script>
